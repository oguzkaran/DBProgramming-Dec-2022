...
namespace SensorAppDAL
{
    public class SensorAppDataHelper //Facade
    {
        ...
        public Task<IEnumerable<SensorInfo>> FindAllSensorsAsync()
        {
            return SubscribeRepository(() => m_sensorRepository.FindAllSensorInfoAsync(), "SensorAppDataHelper.FindAllSensorsAsync");
        }
