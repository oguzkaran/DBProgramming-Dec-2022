...
g.publisher
from games g
where g.is_available = true and g.publisher = 'Yabox';
...
where ptg.game_id = g.game_id and start_date = '2022-11-19' and g.is_available = true;
...
where g.is_available = true and ptgpd .score  > 20000
...
and g.is_available = true and ptgpd .score  > 20000
2
